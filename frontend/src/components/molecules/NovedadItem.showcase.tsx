...
const showcase: ShowcaseEntry = {
  description:
    "Item del feed 'Novedades' del Home HUB. 2 kinds (discriminated union): action (CTA), update (avatar+texto). [TASK-070: kind 'noticia' eliminado]",
  variants: [
    {
      label: "action",
      render: () => (
  ...
  props: [
    { name: "kind", type: "\"action\" | \"update\"", required: true, description: "Discriminante. Cada valor exige un set de props distinto (union type)." },
